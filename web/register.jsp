        ...
        <div class="wrapper">
            <div class="login_box">
                ...
                <form id="loginForm" action="RegisterServlet" method="post">
                    <div class="input_box">
                        <input type="email" id="email" name="Email" class="input-field" required value="${Email}" />
                        <label for="email" class="label">Email</label>
                        <i class="fa-regular fa-envelope"></i>
                    </div>
                    <div class="input_box">
                        <input type="text" id="user" name="Username" class="input-field" required value="${Username}"/>
                    ...
                    <div class="input_box">
                        <input type="text" id="address" name="Address" class="input-field" required value="${Address}"/>
                        <label for="address" class="label">Address</label>
                        <i class="fa-solid fa-map-marker-alt"></i>
                    </div>
                    <div class="input_box">
                        <input type="tel" id="phone" name="Phone" class="input-field" required value="${Phone}" />
