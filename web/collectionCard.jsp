<%-- 
    Document   : collectionCard
    Created on : Jul 15, 2024, 12:55:14 AM
    Author     : ACER
--%>
...
<html lang="en">
                ...
                <body>
                    ...
                    <% CollectionProducts product = (CollectionProducts) request.getAttribute("product");
                    ...
                    <a class="color" href="#"><img src="./image/color/Screenshot 2024-06-23 160859.png" alt="#"></a>
                                    ...
                                    <form id="addToBagForm" action="ShowAddToBag" method="get">
                                        ...
                                        <div class="btn-space">
                                            ...
                                            <button type="button" id="addToBagButton" class="button-86 uk-margin-top text-light btn btnOption" data-id="${products.productID}" align="center">THÊM VÀO GIỎ HÀNG</button>
